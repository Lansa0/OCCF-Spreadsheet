...
namespace
{
    bool verifyOCCF(OCCF& data,unsigned int& rows,unsigned int& columns)
    {
    ...
    void createBorders(const int cell_size,const int columns,std::string& outter_border,std::string& inner_border)
    {
    ...
    void createCellRows(OCCF& sheet_data,std::vector<std::string>& row_list,const int cell_size,const int total_columns)
    {
    ...
    void getInput(int& input,const char* message)
    {
        while (true)
        {
            int Input;
    ...
    void getInput(std::string& input,const char* message)
    {
        while (true)
        {
            std::cout << message;
    ...
    bool parseValue(std::string value,OCCF& data,const int row,const char* column)
    {
